...
SECURITY_TOOL_ENGINE_METASPLOIT_RESULTS_FOLDER=$SECURITY_TOOL_ENGINE_RESULTS_FOLDER/$TOOL_NAME_METASPLOIT
...
mkdir -p $SECURITY_TOOL_ENGINE_METASPLOIT_RESULTS_FOLDER
